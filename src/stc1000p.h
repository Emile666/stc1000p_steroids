...
// Set not Used/Connected port-pins to input with pull-up
#define PA_NC   (0x60)
#define PB_NC   (0x10)
#define PE_NC   (0xD0)
#define PG_NC   (0x03)
...
#define PD_SEG7  (S7_D | S7_E | S7_F | S7_G | S7_DP | S7_A | S7_B)
...
// PORTA IO: outputs: Alarm = PA4, SSR = PA3, Cool = PA2, Heat = PA1
#define ALARM    (0x40)
#define S3       (0x08)
#define COOL     (0x04)
#define HEAT     (0x02)
...
// PD7 PD6 PD5 PD4 PD3 PD2 PE0 PD0
//  D   E   F   G   dp  A   C   B 
#define LED_OFF	(0x00)
#define LED_ON  (0xFF)
#define LED_0	  (0xE7)
